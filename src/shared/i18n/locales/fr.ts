export const frMessages = {
  ...
  visitorGraph: {
    ...
    legend: {
      ...
      risk: 'Domaine de diagnostic le plus faible (taille = nombre de visiteurs)',
      strength: 'Domaine de diagnostic le plus fort (taille = nombre de visiteurs)',
      scenarioWeak: 'Mise en situation la plus faible (taille = nombre de visiteurs)',
      scenarioStrong: 'Mise en situation la plus forte (taille = nombre de visiteurs)',
