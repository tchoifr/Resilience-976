export const frMessages = {
  ...
  visitorGraph: {
    ...
    intro:
      'Chaque point est un visiteur anonyme (identifiant local, sans donnée personnelle). Cinq liens possibles, activables séparément : la campagne dont il fait partie, le domaine le plus faible et le plus fort de son dernier diagnostic, et le scénario de mise en situation le plus faible et le plus fort parmi ceux qu’il a joués. Deux visiteurs ne sont jamais reliés directement entre eux : ils partagent seulement un nœud commun.',
    backToDashboard: 'Retour au tableau de bord',
    ...
    summary: {
      ...
      totalRiskDomains: 'Domaines les plus faibles représentés',
      totalStrengthDomains: 'Domaines les plus forts représentés',
    ...
    legend: {
      title: 'Légende',
      hubsTitle: 'Gros points — regroupements',
      hubsHint:
        'Un gros point rassemble plusieurs visiteurs (campagne, domaine ou mise en situation) : plus il y a de visiteurs, plus il est grand.',
      visitorsTitle: 'Petits points — visiteurs',
      visitorsHint:
        'Un petit point est un seul visiteur, coloré selon son avancement le plus poussé.',
      campaign: 'Campagne',
      risk: 'Domaine de diagnostic le plus faible',
      strength: 'Domaine de diagnostic le plus fort',
      scenarioWeak: 'Mise en situation la plus faible',
      scenarioStrong: 'Mise en situation la plus forte',
      visited: 'Page vue seulement',
      engaged: 'Diagnostic commencé',
      actioned: 'Plan, checklist, kit ou PDF ouvert',
    ...
    tooltip: {
      ...
      weakestScenario: 'Mise en situation la plus faible :',
      strongestScenario: 'Mise en situation la plus forte :',
